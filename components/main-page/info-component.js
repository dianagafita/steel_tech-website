...
export default function InfoComponent() {
  return (
    <div className="bg-[#2B2A27] py-5 xl:px-[10vw]  text-white flex flex-col md:flex-row justify-between w-full">
      {/* Left Side Text */}
      <div className="px-5 pt-5 flex flex-col h-full w-full md:w-1/2 mt-10">
        ...
        <div className="flex flex-col w-full items-end p-5">
          <span className="flex flex-col text-[#757471] font-100 text-[14px] w-[200px] mb-5">
            Make your own project come true with our help! Give us your project
            idea and we will make it happen!
            <button className="flex justify-between my-5 text-[var(--main-color)] rounded-sm  text-[12px] py-1 ">
              DETALII
              <FaArrowRightLong />
            </button>
          </span>
